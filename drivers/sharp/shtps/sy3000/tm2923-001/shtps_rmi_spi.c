...
static void shtps_get_lpwg_def_settings(struct shtps_rmi_spi *ts)
{
	...
	shtps_rmi_read_block(ts, ts->map.fn11.ctrlBase + 0x3C, ts->lpwg.fn11_ctrl92_settings, 0x10, buf);
...
static void shtps_set_lpwg_mode_on(struct shtps_rmi_spi *ts)
{
	...
	shtps_rmi_write_block(ts, ts->map.fn11.ctrlBase + 0x3C, ts->lpwg.fn11_ctrl92_settings, 
