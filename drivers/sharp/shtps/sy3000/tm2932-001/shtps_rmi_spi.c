/* drivers/sharp/shtps/sy3000/tm2932-001/shtps_rmi_spi.c
 *
 ...
 */
		...
		#include "shtps_fw_tm2932-001_a1.h"
		#include "shtps_fw_tm2932-001_b0.h"
		#include "shtps_fw_tm2932-001.h"
	#else
		#include "shtps_fw_tm2932-001.h"
...
#define SHTPS_QOS_LATENCY_DEF_VALUE	 			34
	...
	#define SHTPS_HOVER_CTRL_BASE_ADR_A1			0x09
		...
		static int SHTPS_HOVER_THRESH_FOR_ADC =		0x40;
		...
		#endif /* SHTPS_CHECK_HWID_ENABLE */
		#define SHTPS_HOVER_THRESH_FOR_ADC			0x40
	...
	#define SHTPS_LPWG_REPORT_WG_ONLY						0x02
		...
		static int SHTPS_LPWG_DOZE_WAKEUP_THRESHOLD_DEF = 	0x11;
		...
		#define SHTPS_LPWG_DOZE_WAKEUP_THRESHOLD_DEF		0x11
		...
		#if defined( SHTPS_HOST_LPWG_MODE_ENABLE )
			#define SHTPS_LPWG_DOZE_IN_WAIT_MS	 			300
			#define SHTPS_LPWG_MIN_NOTIFY_INTERVAL			500
		#endif /* SHTPS_HOST_LPWG_MODE_ENABLE */
	#endif /* SHTPS_DEBUG_VARIABLE_DEFINES ) */
#endif /* SHTPS_LPWG_MODE_ENABLE */
...
static void shtps_read_touchevent_insleep(struct shtps_rmi_spi *ts, int state)
{
	...
	status = shtps_rmi_read_packet(ts, ts->map.fn01.dataBase, buf, 2);
	#if defined( SHTPS_HOST_LPWG_MODE_ENABLE )
