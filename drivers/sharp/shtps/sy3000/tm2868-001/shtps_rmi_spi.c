/* drivers/sharp/shtps/sy3000/tm2868-001/shtps_rmi_spi.c
 *
 ...
 */
		...
		#include "shtps_fw_tm2868-001_a1.h"
		#include "shtps_fw_tm2868-001_b0.h"
	#else
		#include "shtps_fw_tm2868-001.h"
...
#define SHTPS_TOUCH_CANCEL_COORDINATES_Y		9999
	...
	#if defined( SHTPS_DEBUG_VARIABLE_DEFINES )
		static int SHTPS_CHARGER_ARMOR_STRENGTH_DEFAULT =	0x30;
	...
	#else
		#define SHTPS_CHARGER_ARMOR_STRENGTH_DEFAULT		0x30
	...
	#define SHTPS_LPWG_REPORT_WG_ONLY						0x02
			...
			static int SHTPS_HOST_LPWG_ENABLE = 			0x00;
		...
		static int SHTPS_LPWG_DOZE_WAKEUP_THRESHOLD_DEF = 	0x3E;
		static int SHTPS_LPWG_DOZE_WAKEUP_THRESHOLD =	 	0x3E;
		...
		static int SHTPS_LPWG_MIN_NOTIFY_INTERVAL = 		1000;
		#if defined( SHTPS_HOST_LPWG_MODE_ENABLE )
			static int SHTPS_LPWG_SWIPE_DIST_THRESHOLD = 	300;
			static int SHTPS_LPWG_SWIPE_CHECK_TIME_MS = 	500;
		#endif /* SHTPS_HOST_LPWG_MODE_ENABLE */

		#if defined( SHTPS_MODULE_PARAM_ENABLE )
			#if defined( SHTPS_HOST_LPWG_MODE_ENABLE )
				module_param(SHTPS_HOST_LPWG_ENABLE, int, S_IRUGO | S_IWUSR);
			#endif /* SHTPS_HOST_LPWG_MODE_ENABLE */
			...
			#if defined( SHTPS_HOST_LPWG_MODE_ENABLE )
				module_param(SHTPS_LPWG_SWIPE_DIST_THRESHOLD, int, S_IRUGO | S_IWUSR);
				module_param(SHTPS_LPWG_SWIPE_CHECK_TIME_MS, int, S_IRUGO | S_IWUSR);
			#endif /* SHTPS_HOST_LPWG_MODE_ENABLE */
		#endif /* SHTPS_MODULE_PARAM_ENABLE */
	#else
		#if defined( SHTPS_HOST_LPWG_MODE_ENABLE )
			#define SHTPS_HOST_LPWG_ENABLE					0x00
		#endif /* SHTPS_HOST_LPWG_MODE_ENABLE */
		#define SHTPS_LPWG_ENABLE_GESTURE					0x02
		#define SHTPS_LPWG_DOZE_INTERVAL_DEF				0x01
		#define SHTPS_LPWG_DOZE_INTERVAL					0x05
		#define SHTPS_LPWG_DOZE_WAKEUP_THRESHOLD_DEF		0x3E
		#define SHTPS_LPWG_DOZE_WAKEUP_THRESHOLD			0x3E
		...
		#if defined( SHTPS_HOST_LPWG_MODE_ENABLE )
			#define SHTPS_LPWG_SWIPE_DIST_THRESHOLD 		300
			#define SHTPS_LPWG_SWIPE_CHECK_TIME_MS			500
		#endif /* SHTPS_HOST_LPWG_MODE_ENABLE */
	#endif /* SHTPS_DEBUG_VARIABLE_DEFINES ) */
...
#define SHTPS_GET_HW_VERSION_RET_MP			7
		...
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_X =	71;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_Y =	1005;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_DISTANCE = 		480;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_CHECK_TYPE = 	1;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO =		117;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_DIFF =		4;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_EFFECT_TIME =	500;
			...
			module_param(SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_CHECK_TYPE, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_DIFF, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_EDGE_FAIL_TOUCH_REJECT_EFFECT_TIME, int, S_IRUGO | S_IWUSR);
		#endif /* SHTPS_MODULE_PARAM_ENABLE */
	#else
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_ENABLE			1
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_X	71
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_Y	1005
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_DISTANCE		480
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_CHECK_TYPE	1
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO		117
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_DIFF			4
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_EFFECT_TIME	500
	#endif /* SHTPS_DEBUG_VARIABLE_DEFINES ) */
	...
	#if defined( SHTPS_DEBUG_VARIABLE_DEFINES )
		static int SHTPS_GRIP_FAIL_TOUCH_REJECT_ENABLE =			1;
		static int SHTPS_GRIP_FAIL_TOUCH_REJECT_AREA =				350;
		static int SHTPS_GRIP_FAIL_TOUCH_REJECT_W_THRESH =			40;

		static int SHTPS_GRIP_FAIL_FLICK_REJECT_ENABLE =			1;
		static int SHTPS_GRIP_FAIL_FLICK_REJECT_AREA =				350;
		static int SHTPS_GRIP_FAIL_FLICK_REJECT_W_THRESH =			40;

		#if defined( SHTPS_MODULE_PARAM_ENABLE )
			module_param(SHTPS_GRIP_FAIL_TOUCH_REJECT_ENABLE, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_GRIP_FAIL_TOUCH_REJECT_AREA, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_GRIP_FAIL_TOUCH_REJECT_W_THRESH, int, S_IRUGO | S_IWUSR);

			module_param(SHTPS_GRIP_FAIL_FLICK_REJECT_ENABLE, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_GRIP_FAIL_FLICK_REJECT_AREA, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_GRIP_FAIL_FLICK_REJECT_W_THRESH, int, S_IRUGO | S_IWUSR);
		#endif /* SHTPS_MODULE_PARAM_ENABLE */
	#else
		#define SHTPS_GRIP_FAIL_TOUCH_REJECT_ENABLE				1
		#define SHTPS_GRIP_FAIL_TOUCH_REJECT_AREA				350
		#define SHTPS_GRIP_FAIL_TOUCH_REJECT_W_THRESH			40

		#define SHTPS_GRIP_FAIL_FLICK_REJECT_ENABLE				1
		#define SHTPS_GRIP_FAIL_FLICK_REJECT_AREA				350
		#define SHTPS_GRIP_FAIL_FLICK_REJECT_W_THRESH			40
	#endif /* SHTPS_DEBUG_VARIABLE_DEFINES ) */

	#if defined( SHTPS_LOG_DEBUG_ENABLE )
		static int SHTPS_GRIP_FAIL_TOUCH_REJECT_LOG_ENABLE = 0;
		module_param(SHTPS_GRIP_FAIL_TOUCH_REJECT_LOG_ENABLE, int, S_IRUGO | S_IWUSR);
...
static void shtps_edge_fail_touch_set_inhibit_finger(struct shtps_rmi_spi *ts, u8 finger, u8 area)
{
	ts->edge_fail_touch_inhibit_id |= (1 << ts->edge_fail_touch_td_info[finger].id);
		...
		if(area == 2){
			...
			SHTPS_LOG_DBG_PRINT("right edge inhibit finger : 0x%02x\n", ts->right_edge_fail_touch_inhibit_id);
		}
	#endif /* SHTPS_TOUCHKEY_FAIL_TOUCH_REJECTION_ENABLE */
			...
			if(td_area_1st != 0){
					...
					if(td_area_2nd != 0){
						if(td_area_1st == td_area_2nd){
							...
							if(distance >= (SHTPS_EDGE_FAIL_TOUCH_REJECT_DISTANCE * SHTPS_EDGE_FAIL_TOUCH_REJECT_DISTANCE)){
								if(SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_CHECK_TYPE == 0){
								...
								else if(SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_CHECK_TYPE == 1){
									if(ts->edge_fail_touch_td_info[0].z < ts->edge_fail_touch_td_info[1].z){
										if( ((ts->edge_fail_touch_td_info[1].z * 100) / ts->edge_fail_touch_td_info[0].z) >= SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO ){
											if(ts->edge_fail_touch_pre_single != 0){
												SHTPS_LOG_DBG_EDGE_FAIL_TOUCH_PRINT("touch cancel event report\n");
												shtps_event_touch_cancel(ts, ts->edge_fail_touch_td_info[0].id);
											}
								...
								else if(SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_CHECK_TYPE == 2){
									if(ts->edge_fail_touch_td_info[0].z < ts->edge_fail_touch_td_info[1].z){
										if( (ts->edge_fail_touch_td_info[1].z - ts->edge_fail_touch_td_info[0].z) >= SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_DIFF ){
											if(ts->edge_fail_touch_pre_single != 0){
												SHTPS_LOG_DBG_EDGE_FAIL_TOUCH_PRINT("touch cancel event report\n");
												shtps_event_touch_cancel(ts, ts->edge_fail_touch_td_info[0].id);
											}
										...
										if( (ts->edge_fail_touch_td_info[0].z - ts->edge_fail_touch_td_info[1].z) >= SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_DIFF ){
											SHTPS_LOG_DBG_EDGE_FAIL_TOUCH_PRINT("[2-1]inhibit id : %d\n", ts->edge_fail_touch_td_info[1].id);
											shtps_edge_fail_touch_set_inhibit_finger(ts, 1, td_area_2nd);
										}
										else{
				...
				if(td_area_2nd != 0){
					...
					if(SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_CHECK_TYPE == 0){
						...
						if(distance >= (SHTPS_EDGE_FAIL_TOUCH_REJECT_DISTANCE * SHTPS_EDGE_FAIL_TOUCH_REJECT_DISTANCE)){
							if(SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_CHECK_TYPE == 1){
								...
								if( (now_z_1 - now_z_2) >= SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_DIFF ){
									SHTPS_LOG_DBG_EDGE_FAIL_TOUCH_PRINT("[2-2]inhibit add id : %d\n", ts->edge_fail_touch_td_info[1].id);
									shtps_edge_fail_touch_set_inhibit_finger(ts, 1, td_area_2nd);
								}
								else{
...
static void shtps_calc_notify(struct shtps_rmi_spi *ts, u8 *buf, struct shtps_touch_info *info, u8 *event)
{
	...
	#if defined(SHTPS_CLING_REJECTION_ENABLE)
	{
		...
		if(is_touch_down == 0){
			shtps_rmi_write(ts, ts->map.fn54.commandBase, 0x02);
			SHTPS_LOG_DBG_PRINT("Force_Cal set by touch up detect\n");
		}
	}
		...
		shtps_calc_notify(ts, &buf[2], &info, &event);
			...
			if(is_hold_keyevent){
				if(SHTPS_TOUCHKEY_FAIL_TOUCH_REJECTION_DISABLE == 0 && ts->right_edge_fail_touch_inhibit_id != 0){
					...
					SHTPS_LOG_DBG_PRINT("[edge and touchkey exclude] ignore vol-up key down\n");
				}
				shtps_key_event_report(ts, present_key_state);
			}
		#endif /* SHTPS_TOUCHKEY_FAIL_TOUCH_REJECTION_ENABLE */
