...
#if defined(CONFIG_MACH_LYNX_DL40) || defined(CONFIG_MACH_DECKARD_AS97) || defined(CONFIG_MACH_DECKARD_AS87) || defined(FEATURE_SH_MODEL_DL40) || defined(FEATURE_SH_MODEL_AS97) || defined(FEATURE_SH_MODEL_AS87)
#define SHCAM_LED_TORCH_CURRENT 25
#else
#define SHCAM_LED_TORCH_CURRENT 50
#endif
#define SHCAM_LED_FLASH_CURRENT 150
/* SHLOCAL_CAMERA_DRIVERS<- */
