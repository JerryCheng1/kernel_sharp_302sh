...
#else
#if defined(CONFIG_MACH_LYNX_DL40) || defined(CONFIG_MACH_DECKARD_AS97) || defined(CONFIG_MACH_ATK) || defined(CONFIG_MACH_LYNX_DL45) || defined(CONFIG_MACH_DECKARD_AS87) || defined(CONFIG_MACH_TBS)
#else
#define SHDISP_NOT_SUPPORT_DET
#endif
#endif
